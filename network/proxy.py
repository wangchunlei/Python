...
def main():
    ...
    if len(sys.argv[1:]) != 5:
        print "Usage: ./proxy.py [lcoalhost] [localport] [remotehost] [remoteport] [receive_first]"
...
def receive_from(connection):
    ...
    # Wet set a 2 second timeout; depending on your target, this mya need to be adjusted
